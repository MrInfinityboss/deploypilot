...
```bash
curl -fsSL https://raw.githubusercontent.com/MrInfinityboss/deploypilot/v1.0.6/scripts/install-worker.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/MrInfinityboss/deploypilot/v1.0.6/scripts/install-worker.ps1 | iex
```
